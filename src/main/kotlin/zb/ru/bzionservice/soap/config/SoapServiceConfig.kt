package zb.ru.bzionservice.soap.config
...
@EnableWs
@Configuration
class SoapServiceConfig : WsConfigurerAdapter() {
    @Bean
    ...
    fun defaultWsdl11Definition(unit4TransferSchema: XsdSchema?): DefaultWsdl11Definition? {
        val wsdl11Definition = DefaultWsdl11Definition()
        wsdl11Definition.setPortTypeName("Unit4TransferPort")
        wsdl11Definition.setLocationUri("/ws")
        wsdl11Definition.setTargetNamespace("http://spring.io/guides/gs-producing-web-service")
        wsdl11Definition.setSchema(unit4TransferSchema)
